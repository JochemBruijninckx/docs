<ResponseField name="demand" type="demand Object">
  <Expandable title="properties">
    <ResponseField name="days" type="object Object">
    ...
    <ResponseField name="shiftDemands" type="array of shiftDemand Object">
    ...
    <Expandable title="shiftDemands – item structure">
      <ResponseField name="shiftId" type="string">
        Id of the shift for which there is demand. Required.
      </ResponseField>
      ...
      <ResponseField name="ideal" type="integer">
        Ideal number of employees needed to cover the demand. The solver prefers to cover the demand with exactly this number of employees. Required.
      </ResponseField>
      ...
      <ResponseField name="attributeRequirementGroups" type="array of attributeRequirementGroup Object">
    ...
    <ResponseField name="timeDemands" type="array of timeDemand Object">
      List of time demands that exist on the days specified in the days field.
    </ResponseField>
    <Expandable title="timeDemands – item structure">
      <ResponseField name="timeSlotId" type="string">
        Id of the time slot for which there is demand. Required.
      </ResponseField>
      <ResponseField name="min" type="integer">
        Minimum number of employees needed to cover the demand. The solver will try to cover the demand with at least this number of employees. If not specified, will be equal to ideal.
      </ResponseField>
