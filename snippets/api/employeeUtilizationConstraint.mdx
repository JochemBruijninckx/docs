<ResponseField name="employeeUtilizationConstraint">
  ...
  <Expandable title="properties">
    ...
    <ResponseField name="defaultTime">
    ...
    <ResponseField name="overlapRules">
