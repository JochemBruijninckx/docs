<ResponseField name="shift" type="object">
  <Expandable title="properties">
    ...
    <ResponseField name="connectedShiftsPreviousDay" type="object">
    ...
    <Expandable title="connectedShiftsPreviousDay – properties">
      <ResponseField name="shiftIds" type="array of shiftId">
    ...
    <ResponseField name="connectedShiftsNextDay" type="object">
