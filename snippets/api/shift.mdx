<ResponseField name="shift" type="shift Object">
  <Expandable title="properties">
    <ResponseField name="id" type="string">
      Unique identifier for the shift. Required.
    </ResponseField>
    ...
    <ResponseField name="availableDays" type="days Object">
    ...
    <ResponseField name="intervals" type="array of shiftInterval Object">
      List of intervals that this shift consists of. The maximum duration of a shift is 72 hours. Required.
    </ResponseField>
    <Expandable title="intervals – item structure">
      <ResponseField name="startTime" type="string (time)">
        TIME ISO 8601 format hh:mm. Equivalent to the 24h format of a single day. Use 00:00 to represent midnight. Required.
      </ResponseField>
      <ResponseField name="endTime" type="string (time)">
        TIME ISO 8601 format hh:mm. Equivalent to the 24h format of a single day. Use 00:00 to represent midnight. Required.
      </ResponseField>
      <ResponseField name="dayIndicator" type="integer">
        Indicates which day this interval belongs to, relative to the day that the shift belongs to. -1 indicates the interval starts on the previous day, 0 on the same day, and 1 on the next day. Required.
      </ResponseField>
      <ResponseField name="workload" type="object Object">
    ...
    <ResponseField name="connectedShiftsPreviousDay" type="connectedShifts Object">
    ...
    <ResponseField name="connectedShiftsNextDay" type="connectedShifts Object">
    ...
    <ResponseField name="attributeRequirements" type="array of attributeRequirement Object">
