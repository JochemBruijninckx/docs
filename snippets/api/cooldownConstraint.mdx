<ResponseField name="cooldownConstraint" type="cooldownConstraint Object">
  <Expandable title="properties">
    ...
    <ResponseField name="starts" type="cooldownStartsOrEnds Object">
    ...
    <Expandable title="starts – properties">
      <ResponseField name="shifts" type="object Object">
      ...
      <Expandable title="shifts – properties">
        ...
        <ResponseField name="matchType" type="string (enum: NONE | ANY | ALL)">
          DEPRECATED - Use 'advanced' instead. Default: "ANY".
        </ResponseField>
      </Expandable>
    </Expandable>
    <ResponseField name="ends" type="cooldownStartsOrEnds Object">
    ...
    <ResponseField name="targets" type="cooldownTargets Object">
      Defines the desired minimum duration of the cooldown. Can be defined in either hours or days. Required.
    </ResponseField>
