<ResponseField name="employee" type="employee Object">
  <Expandable title="properties">
    <ResponseField name="id" type="string">
      Unique identifier for this employee. Required.
    </ResponseField>
    ...
    <ResponseField name="attributes" type="array of attribute Object">
    ...
    <Expandable title="attributes – item structure">
      ...
      <ResponseField name="values" type="array of string">
        The values that the employee has for this attribute. For example, an employee can have the values "marketing" and "finance" for an attribute with the id "department". Required.
      </ResponseField>
    ...
    <ResponseField name="roles" type="array of object Object">
    ...
    <ResponseField name="preassignedShifts" type="array of preassignedShift Object">
      List of assignments that are pre-assigned to this employee.
    </ResponseField>
    <Expandable title="preassignedShifts – item structure">
      <ResponseField name="shiftId" type="string">
        The id of the shift that is assigned to the employee. Required.
      </ResponseField>
      <ResponseField name="days" type="days Object">
        List of days in the schedule. Days can be defined as an array of dates (in CALENDAR payloads), as an array of day indices (in RECURRING payloads), or as an array of weekdays (allowed in all payloads). Required.
      </ResponseField>
      <Expandable title="days – properties">
        <ResponseField name="dates" type="array of date">
          List of dates in the schedule. Only allowed in CALENDAR payloads.
