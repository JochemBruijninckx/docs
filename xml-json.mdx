...
## WeeklyRestRule ⇒ periodicRestConstraints
...
"employeeUtilizationConstraints": [
  {
    ...
    "filters": {
      "employeeIds": ["1", "2"],
      "shiftTypeIds": ["NIGHT"]       // see comment
    },
    "targets": {
      "minShifts": 1,
      "maxShifts": 10
