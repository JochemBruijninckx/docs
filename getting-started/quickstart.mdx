...
<Steps>
    ...
    Build your roster request payload. See the [API Reference](/api-reference/roster/start-job) for detailed instructions. For your first job, feel free to use the below example payload as a starting point.
