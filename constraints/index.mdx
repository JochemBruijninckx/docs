...
<Columns cols={3}>
  ...
  >
    Block employees from working on specific days or shifts, or make it
    desired/undesired for them to work.
  </Card>
  <Card
  ...
  <Card title="Cooldown" icon="clock" href="/constraints/cooldown">
  ...
  >
    Control the minimum and maximum number of consecutive working days.
  </Card>
  <Card title="Pattern" icon="repeat" href="/constraints/pattern">
    Define work patterns that employees should follow.
  </Card>
  <Card title="Periodic Rest" icon="moon" href="/constraints/periodic-rest">
