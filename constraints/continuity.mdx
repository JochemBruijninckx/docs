...
Each continuity constraint can be assigned a `weight` from 0 to 100 to indicate its [importance](/constraints/index#constraint-importance). Moreover, should a planner require strict continuity for some `continuityGroup`, the `isStrict` property can be used.
