...
import SchemaSnippet from "/snippets/api/demand.mdx";
...
In principle, all employees assigned to a demand must be compatible with the [attribute](/concepts/employees#attributes) requirements on that demand.
